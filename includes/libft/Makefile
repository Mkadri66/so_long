...
#    Updated: 2023/11/05 21:09:22 by mkadri           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS			=	ft_isalnum.c ft_strncmp.c ft_atoi.c ft_isalpha.c ft_strchr.c ft_tolower.c ft_isascii.c ft_strlen.c \
					...
					ft_strtrim.c ft_putchar_fd.c  ft_putstr_fd.c ft_putendl_fd.c ft_memcmp.c  ft_putnbr_fd.c ft_striteri.c ft_strmapi.c ft_split.c ft_itoa.c \
